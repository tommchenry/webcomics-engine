...
describe Comic do
  ...
  let!(:older_comic){Comic.create(title:"Old Comic", alt_text: "I'm older", post_date: "2016-03-12")}
  let!(:comic){Comic.create(title:"Test Comic", alt_text: "alt text", post_date:"2016-04-12")}
